...
# colors shared across all visualizations
PALETTE = {
...
# viz 1: airline on-time performance
print("\nBuilding Viz 1...")
...
# viz 2: delay heatmap by hour and day of week
...
# viz 3: distance vs. delay scatter with linked histogram
...
# viz 4: D3 airport map with data baked inline
...
VIZ4_JS = r"""// generated by generate_vizzes.py — edit the template there, not here
(function () {
  ...
  // tooltip lives on body so it floats above the SVG
  ...
  d3.json('https://cdn.jsdelivr.net/npm/us-atlas@3/states-10m.json').then(function (us) {
    ...
    // gradient legend for the delay color scale
...
# viz 5: daily delay trend by airline
...
VIZ5_JS = r"""// generated by generate_vizzes.py — edit the template there, not here
(function () {
  ...
  // build the airline dropdown controls
  ...
  // background grid, zero baseline, and July 4th marker
  ...
  // invisible rect that catches mouse events for the hover interaction
  ...
  // wire up the dropdown open/close and outside-click dismissal
